...
export const textDefaultColor = '#2A2A2A';
...
export const textDayHeaderFontSize = 11;
...
export const textSectionTitleColor = '#9A9A9A';
...
export const todayTextColor = '#4EC386';
export const dayTextColor = textDefaultColor;
export const textDisabledColor = '#9A9A9A';
